...
export default function () {
  ...
  console.log('  - Metadata:', JSON.stringify(responseWithGzip.headers));
  ...
  // Log compression info
  if (responseWithoutGzip.metadata && responseWithoutGzip.headers['grpc-encoding']) {
  ...
  // Log compression info
  if (responseNoHeader.metadata && responseNoHeader.headers['grpc-encoding']) {
